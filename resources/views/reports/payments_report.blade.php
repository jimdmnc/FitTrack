...
<body>
    ...
    <table class="report-info">
        <tr>
            ...
            <td>{{ $payments->min('payment_date') ? \Carbon\Carbon::parse($payments->min('payment_date'))->format('M d, Y') : now()->format('M d, Y') }} - {{ $payments->max('payment_date') ? \Carbon\Carbon::parse($payments->max('payment_date'))->format('M d, Y') : now()->format('M d, Y') }}</td>
        </tr>
        <tr>
