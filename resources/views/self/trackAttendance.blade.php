...
<head>
    ...
    <title>Track Attendance - Rockies Fitness</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
</head>
<body class="bg-gray-900 text-gray-200 min-h-screen">
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl md:text-4xl font-extrabold text-center text-gray-200 mb-8">
            Track Your Gym Attendance
        </h1>

        <div class="bg-[#1e1e1e] rounded-lg shadow-lg p-6 w-full max-w-3xl mx-auto max-h-[90vh] overflow-y-auto"
             x-data="{
                 selectedAttendance: @json($selectedAttendance),
                 selectedDayDate: '',
            ...
            x-init="$nextTick(() => { selectDay(today); })">
                ...
                <div class="flex justify-between items-center mb-4">
                    <button @click="prevMonth" class="text-gray-400 hover:text-[#ff5722] transition-colors">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                        </svg>
                    </button>
                    <h3 class="text-lg font-medium text-gray-200" x-text="monthName() + ' ' + currentYear"></h3>
                    <button @click="nextMonth" class="text-gray-400 hover:text-[#ff5722] transition-colors">
                        <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
