    ...
    <section id="home" class="relative bg-white min-h-screen flex items-center" style="background-image: url('{{ asset('images/image1.png') }}');">
        ...
        <div class="container mx-auto px-6 z-10">
            ...
            <div class="flex flex-wrap justify-center gap-2 mb-6">
                <a href="#tutorial" class="bg-red-900 hover:bg-orange-700 text-white font-bold py-3 px-6 rounded-lg inline-flex items-center text-sm md:text-base transition duration-300 shadow-lg">
