                ...
                <div class="container mx-auto px-6 z-10">
                    <div class="flex flex-col items-center">
                        ...
                        <div class="flex flex-row flex-wrap justify-center items-center hide-images" id="phone-container">
                            <img src="images/phone111.jpg" alt="Phone Mockup 1" class="w-40 md:w-50 transition-transform duration-500 hover:scale-105" id="phone2">
                            <img src="images/phone222.jpg" alt="Phone Mockup 2" class="w-40 md:w-50 transition-transform duration-500 hover:scale-105" id="phone1">
                        </div>
