...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="flex items-center">
            <a href="{{ route('self.registration') }}" class="font-semibold bg-gradient-to-r from-orange-600 to-orange-700 text-white px-4 py-2 rounded-full hover:from-orange-700 hover:to-orange-800 transition duration-300 shadow-lg hover:shadow-orange-800/50">
            Register
            </a>
        </div>
    </div>
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-gray-900 mt-4 p-4 rounded-lg">
        ...
        <a href="{{ route('self.registration') }}" class="block py-2 text-center text-white rounded-full mt-2 hover:from-orange-700 hover:to-orange-800 transition duration-300">
            Register
        </a>
    </div>
</nav>
...
<div class="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
  ...
  <img src="/images/tutorial1.jpg" alt="Visit Website" class="rounded-lg mx-auto mt-4 w-full h-48 object-cover">
</div>
...
<div class="bg-gray-100 p-8 rounded-lg shadow-lg text-center">
  ...
  <img src="/images/welcomebg.jpg" alt="Time Out" class="rounded-lg mx-auto mt-4 w-full h-48 object-cover">
</div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="https://www.instagram.com/rockies_fitness/" class="text-gray-400 hover:text-red-500 transition duration-300"><i class="fab fa-instagram text-xl"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
