                    ...
                    <tr class="bg-gradient-to-br from-[#2c2c2c] to-[#1e1e1e] text-gray-200 text-sm border-b border-black" data-staff-id="{{ $staff->id }}">
                        ...
                        <td class="p-3 text-center">
                            <div class="flex justify-center gap-2">
                                <button onclick="openEditModal({{ $staff->id }})" class="bg-blue-300 text-blue-500 px-3 py-2 font-bold rounded-md text-md hover:translate-y-[-2px] hover:bg-blue-400 transition-colors flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
