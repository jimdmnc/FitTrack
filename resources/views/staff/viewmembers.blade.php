                                ...
                                @elseif($member->member_status == 'expired')
                                    <div class="flex flex-wrap gap-2 justify-center">
                                        <button 
                                            ...
                                            class="inline-flex items-center px-3 py-1.5 bg-green-900 hover:bg-transparent hover:translate-y-[-2px] text-green-200 rounded-lg transition-all duration-200 font-medium text-sm border border-[#ff5722] shadow-sm group"
