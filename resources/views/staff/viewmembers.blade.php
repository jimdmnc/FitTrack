...
<div id="upgradeMemberModal" class="fixed inset-0 bg-[#1e1e1e] bg-opacity-70 flex justify-center items-center hidden z-50 transition-opacity duration-300 p-4">
    <div class="w-full max-w-3xl max-h-[90vh] overflow-y-auto transform transition-all duration-300 scale-95 opacity-0" id="upgradeModalContent">
        
        <div class="bg-[#1e1e1e] rounded-xl shadow-2xl border border-gray-700">
            <!-- Modal Header -->
            <div class="flex justify-between items-center p-3 sm:p-4 border-b border-gray-700 sticky top-0 bg-gradient-to-br from-[#2c2c2c] to-[#1e1e1e] z-10">
                <h2 class="text-base sm:text-lg font-bold text-gray-200 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-[#ff5722]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <form id="upgradeForm" action="{{ route('upgrade.membership') }}" method="POST" class="p-4 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    <!-- Membership Type -->
                    <div class="w-full">
                        <label class="block text-xs sm:text-sm font-medium text-gray-300 mb-1" for="upgradeMembershipType">Choose Your Plan <span class="text-red-500">*</span></label>
                    ...
                    <!-- End Date -->
                    <div class="w-full">
                        <label class="block text-xs sm:text-sm font-medium text-gray-300 mb-1" for="upgradeEndDate">End Date</label>
                    ...
                    <!-- RFID Card -->
                    <div class="w-full rfid-container">
                        <label class="block text-xs sm:text-sm font-medium text-gray-300 mb-1" for="upgradeUid">Tap Your RFID Card <span class="text-red-500">*</span></label>
                        <div class="relative">
                            <input id="upgradeUid" name="uid" class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-600 rounded-lg bg-[#2c2c2c] text-gray-200 text-xs sm:text-sm text-center font-mono tracking-wider cursor-default pointer-events-none select-none" placeholder="Waiting for card tap..." readonly aria-describedby="upgrade_uid_error" required>
                            <div class="absolute right-3 top-1/2 -translate-y-1/2 flex items-center" id="upgrade-rfid-loading">
                                <span class="h-2 w-2 bg-[#ff5722] rounded-full animate-pulse mr-1"></span>
                                <span class="h-2 w-2 bg-[#ff5722] rounded-full animate-pulse mr-1" style="animation-delay: 0.2s;"></span>
                                <span class="h-2 w-2 bg-[#ff5722] rounded-full animate-pulse" style="animation-delay: 0.4s;"></span>
                            </div>
                        ...
                        <div id="upgrade_rfid_status" class="flex items-center justify-center gap-2 text-gray-400 text-xs mt-1" aria-live="polite">
                        ...
                        @error('uid')
                            <span id="upgrade_uid_error" class="text-red-500 text-xs mt-1 flex items-center gap-1" aria-live="polite">
                    ...
                    <!-- Membership Fee -->
                    <div class="w-full">
                        <label class="block text-xs sm:text-sm font-medium text-gray-300 mb-1" for="upgradeMembershipFee">Total Amount (₱)</label>
                        <input type="text" id="upgradeMembershipFee" class="w-full px-2 sm:px-3 py-1.5 sm:py-2 border border-gray-600 rounded-lg bg-[#2c2c2c] text-gray-200 text-xs sm:text-sm pointer-events-none" value="₱0" readonly>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end sm:space-x-3 space-y-2 sm:space-y-0 mt-5 pt-4 border-t border-gray-700">
                    ...
                    <button type="submit" id="submitUpgrade" class="w-full sm:w-auto px-4 py-2 bg-[#ff5722] hover:bg-opacity-80 hover:translate-y-[-2px] text-white rounded-lg transition-colors duration-200 font-medium flex items-center justify-center text-xs sm:text-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                        </svg>
                        Complete Upgrade
