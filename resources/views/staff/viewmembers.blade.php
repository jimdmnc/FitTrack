                                ...
                                @if($member->member_status == 'active')
                                    <div class="flex flex-col md:flex-row flex-wrap gap-1 sm:gap-2 justify-center items-center">
                                        ...
                                        >
                                            ...
                                            <span class="ml-1 sm:max-w-0 sm:overflow-hidden sm:group-hover:max-w-xs sm:group-hover:ml-1.5 sm:transition-all sm:duration-300 sm:ease-in-out">View</span>
                                        </button>
                                        <button 
                                            onclick="openRevokeModal('{{ $member->rfid_uid }}', '{{ $member->first_name }} {{ $member->last_name }}')"
                                            class="inline-flex items-center justify-center w-full sm:w-auto px-2 sm:px-3 py-1.5 bg-red-600 hover:bg-transparent hover:translate-y-[-2px] text-gray-200 rounded-lg transition-all duration-200 font-medium text-xs sm:text-sm border border-red-600 shadow-sm group min-w-0"
                                        ...
                                        >
                                            ...
                                            <span class="ml-1 sm:max-w-0 sm:overflow-hidden sm:group-hover:max-w-xs sm:group-hover:ml-1.5 sm:transition-all sm:duration-300 sm:ease-in-out">Revoke</span>
                                        </button>
                                    </div>
                                @elseif($member->member_status == 'expired')
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-1 sm:gap-2 justify-center items-center">
                                        ...
                                        >
                                            ...
                                            <span class="ml-1 sm:max-w-0 sm:overflow-hidden sm:group-hover:max-w-xs sm:group-hover:ml-1.5 sm:transition-all sm:duration-300 sm:ease-in-out">Renew</span>
                                        </button>
                                        <button 
                                            onclick="openRevokeModal('{{ $member->rfid_uid }}', '{{ $member->first_name }} {{ $member->last_name }}')"
                                            class="inline-flex items-center justify-center w-full sm:w-auto px-2 sm:px-3 py-1.5 bg-red-600 hover:bg-transparent hover:translate-y-[-2px] text-gray-200 rounded-lg transition-all duration-200 font-medium text-xs sm:text-sm border border-red-600 shadow-sm group min-w-0"
                                ...
                                @elseif($member->member_status == 'revoked')
                                    <div class="flex flex-col sm:flex-row flex-wrap gap-1 sm:gap-2 justify-center items-center">
                                        ...
                                        >
                                            ...
                                            <span class="ml-1 sm:max-w-0 sm:overflow-hidden sm:group-hover:max-w-xs sm:group-hover:ml-1.5 sm:transition-all sm:duration-300 sm:ease-in-out">Reason</span>
                                        </button>
                                        <button 
                                            onclick="openRestoreModal('{{ $member->rfid_uid }}', '{{ $member->first_name }} {{ $member->last_name }}')" 
                                            class="inline-flex items-center justify-center w-full sm:w-auto px-2 sm:px-3 py-1.5 bg-green-600 hover:bg-transparent hover:translate-y-[-2px] text-gray-200 rounded-lg transition-all duration-200 font-medium text-xs sm:text-sm border border-green-600 shadow-sm group min-w-0"
                                        ...
                                        >
                                            ...
                                            <span class="ml-1 sm:max-w-0 sm:overflow-hidden sm:group-hover:max-w-xs sm:group-hover:ml-1.5 sm:transition-all sm:duration-300 sm:ease-in-out">Restore</span>
                                        </button>
                                    </div>
                                @endif
                            </td>
