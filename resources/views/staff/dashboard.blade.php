...
<script>
    ...
    <div id="editAnnouncementModal" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center hidden z-50 backdrop-blur-sm p-4">
        <div class="bg-[#1e1e1e] rounded-lg shadow-2xl border border-gray-800 w-full max-w-sm mx-auto transform transition-all duration-300 ease-in-out scale-95 hover:scale-100 max-h-[90vh] overflow-y-auto">
            <!-- Compact Header -->
            ...
            <form id="editAnnouncementForm" method="POST" class="p-4 space-y-4">
                ...
                <!-- Title Field -->
                <div>
                    <label for="edit_title" class="block text-xs font-medium text-gray-400 mb-1">Title</label>
                    <input type="text" name="title" id="edit_title" 
                        class="w-full bg-gray-800 border border-gray-700 text-gray-100 rounded-md p-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#FF5722] transition duration-300" 
                        required 
                ...
                <!-- Content Field -->
                <div>
                    <label for="edit_content" class="block text-xs font-medium text-gray-400 mb-1">Content</label>
                    <textarea name="content" id="edit_content" 
                        class="w-full bg-gray-800 border border-gray-700 text-gray-100 rounded-md p-2 text-sm min-h-[80px] focus:outline-none focus:ring-1 focus:ring-[#FF5722] transition duration-300" 
                        required 
                        placeholder="Write announcement details"></textarea>
                </div>
                
                <!-- Schedule Field -->
                <div>
                    <label for="edit_schedule" class="block text-xs font-medium text-gray-400 mb-1">Schedule (Optional)</label>
                ...
                <!-- Type Field -->
                <div>
                    <label for="edit_type" class="block text-xs font-medium text-gray-400 mb-1">Type</label>
                    <div class="relative">
                        <select name="type" id="edit_type" 
                            class="w-full bg-gray-800 border border-gray-700 text-gray-100 rounded-md p-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#FF5722] transition duration-300 appearance-none" 
                            required>
                ...
                <div class="flex justify-end space-x-2 pt-2">
                    <button type="button" id="closeEditModalBtn" 
                        class="bg-gray-800 text-gray-300 px-3 py-1.5 text-sm rounded-md hover:bg-gray-700 transition duration-300 border border-gray-700">
                        Cancel
                    </button>
                    <button type="submit" 
                        class="bg-[#FF5722] text-white px-3 py-1.5 text-sm rounded-md hover:bg-[#e64a19] transition duration-300 flex items-center">
