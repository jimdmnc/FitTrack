                        ...
                        <td class="p-3 text-center">
                            <div class="flex justify-center gap-2">
                                <form action="{{route('staff.approveUser', $user->id)}}" method="POST" class="inline-block">
                                    @csrf
                                    @method('PUT')
                                    <button type="submit" class="bg-green-900 text-green-200 px-3 py-2 rounded-md text-sm hover:translate-y-[-2px] hover:bg-green-600 transition-colors flex items-center">
                                ...
                                <button onclick="rejectUser({{ $user->id }})" class="bg-red-900 text-red-200 px-3 py-2 rounded-md text-sm hover:translate-y-[-2px] hover:bg-red-600 transition-colors flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
