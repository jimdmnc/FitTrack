...
<div class="flex items-center p-6">
            ...
            <span x-show="open || isMobile" class="text-xl font-bold text-white" style="line-height: 1; font-family: 'Rajdhani', sans-serif;">
    Rockies <br>Fitness
</span>
            </div>
        ...
        <div class="flex flex-col flex-grow px-4 mt-5">
            ...
            <a href="{{ route('staff.dashboard') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-md group 
                {{ Request::routeIs('staff.dashboard') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                <svg class="w-6 h-6 mr-3 {{ Request::routeIs('staff.dashboard') ? 'text-white' : 'text-gray-300' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="{{ route('staff.membershipRegistration') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                {{ Request::routeIs('staff.membershipRegistration') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                <svg class="w-6 h-6 mr-3 {{ Request::routeIs('staff.membershipRegistration') ? 'text-white' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('staff.attendance') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.attendance') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-3 
                        {{ Request::routeIs('staff.attendance') ? 'text-white' : 'text-gray-400' }}" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                ...
                <a href="{{ route('staff.viewmembers') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.viewmembers') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    <svg class="w-6 h-6 mr-3 
                        {{ Request::routeIs('staff.viewmembers') ? 'text-white' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('staff.paymentTracking') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.paymentTracking') ? 'bg-gray-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                    <svg class="w-6 h-6 mr-3 
                        {{ Request::routeIs('staff.paymentTracking') ? 'text-white' : 'text-gray-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="{{ route('staff.connectHardware') }}" 
                        class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                                {{ request()->routeIs('staff.connectHardware') ? 'text-white bg-gray-700' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                            <svg class="w-6 h-6 mr-3 
                                {{ request()->routeIs('staff.connectHardware') ? 'text-white' : 'text-gray-400' }}" 
                        ...
                        <a href="{{ route('staff.report') }}" 
                            class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                                    {{ request()->routeIs('staff.report') ? 'text-white bg-gray-700' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}">
                                <svg class="w-6 h-6 mr-3 
                                    {{ request()->routeIs('staff.report') ? 'text-white' : 'text-gray-400' }}" 
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
