...
<div class="flex items-center p-6">
    ...
    Rockies <span class="gradient-text bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">Fitness
        ...
        <div class="flex flex-col flex-grow px-4 mt-5">
            ...
            <a href="{{ route('staff.dashboard') }}" class="flex items-center px-4 py-2 text-sm font-medium rounded-md group {{ Request::routeIs('staff.dashboard') ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
            ...
            <a href="{{ route('staff.membershipRegistration') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                {{ Request::routeIs('staff.membershipRegistration') ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
                ...
                <a href="{{ route('staff.attendance') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.attendance') ? 'bg-orange-600 text-white group-hover:text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
                ...
                <a href="{{ route('staff.viewmembers') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.viewmembers') ? 'bg-orange-600 text-white group-hover:text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
                ...
                <a href="{{ route('staff.paymentTracking') }}" class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                    {{ Request::routeIs('staff.paymentTracking') ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
                    <svg class="w-6 h-6 mr-3 
                    ...
                    Payment Tracking
                        ...
                        <a href="{{ route('staff.report') }}" 
                            class="flex items-center px-4 py-2 mt-1 text-sm font-medium rounded-md group 
                                    {{ request()->routeIs('staff.report') ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }} transition-transform transform hover:scale-105">
                                <svg class="w-6 h-6 mr-3 
...
<div x-data="{ open: false }" class="mt-1">
    ...
    <button @click="open = !open" 
        ...
        {{ request()->routeIs('profile.edit') ? 'bg-orange-600 text-white' : 'text-gray-400 hover:bg-orange-600 hover:text-white' }}">
    ...
    <div x-show="open" x-transition class="pl-6 mt-1 space-y-1">
        ...
        <a href="{{ route('profile.edit') }}" 
            class="group block text-sm font-medium text-gray-400 rounded-md px-4 py-2 transition-transform transform hover:scale-105 hover:bg-orange-600 hover:text-white">
            View Profile
        </a>
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" 
                class="group w-full text-left flex items-center px-4 py-2 text-sm font-medium text-gray-400 rounded-md transition-transform transform hover:scale-105 hover:bg-orange-600 hover:text-white">
                Log Out
            </button>
        </form>
    </div>
