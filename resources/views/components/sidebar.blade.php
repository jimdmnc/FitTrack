<div class="flex flex-col w-64 h-full overflow-y-auto bg-[#121212] transition-transform duration-300 ease-in-out will-change-transform"
    ...
    <div class="flex flex-col flex-grow px-2 mt-3">
        <nav class="flex-1 space-y-1">
            <span class="text-gray-400 uppercase text-xs font-semibold tracking-wider px-3 py-2">Main</span>
            ...
            <a href="{{ route('staff.manageStaffs') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <span class="whitespace-nowrap">Manage Staffs</span>
            </a>
            @endif
            ...
            <a href="{{ route('staff.paymentTracking') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <svg class="w-5 h-5 mr-2 flex-shrink-0 {{ Request::routeIs('staff.paymentTracking') ? 'text-white' : 'text-gray-400 group-hover/item:text-white' }}" 
                     fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                          d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1mplace-items-centerm0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <span class="whitespace-nowrap">Payment Tracking</span>
            </a>

            <span class="text-gray-400 uppercase text-xs font-semibold tracking-wider px-3 py-2">Members Management</span>
            ...
            <a href="{{ route('staff.membershipRegistration') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <span class="whitespace-nowrap">Register Member</span>
            </a>
            ...
            <a href="{{ route('staff.attendance') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <span class="whitespace-nowrap">Members Attendance</span>
            </a>
            ...
            <a href="{{ route('staff.manageApproval') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <span class="whitespace-nowrap">Manage Approval</span>
            ...
            <a href="{{ route('staff.viewmembers') }}" 
               class="flex items-center px-3 py-2 text-sm font-medium rounded-md group/item 
                ...
                <span class="whitespace-nowrap">Member Status</span>
            </a>
            ...
            <!-- Profile Section -->
            <span class="text-gray-400 uppercase text-xs font-semibold tracking-wider px-3 py-2">Settings</span>
