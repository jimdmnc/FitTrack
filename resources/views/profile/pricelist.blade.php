...
<div class="py-4 px-4 sm:px-6 md:px-8 max-w-6xl mx-auto">
    ...
    <div class="bg-[#1e1e1e] rounded-lg shadow-md p-4 sm:p-6">
        <form id="priceUpdateForm" method="POST" action="{{ route('profile.pricelist.update') }}">
            @csrf
            ...
            <div class="mt-6 flex justify-end">
                <button type="button" id="openConfirmModal" class="bg-orange-600 hover:bg-orange-700 hover:translate-y-[-2px] text-white py-2 px-6 rounded-md font-medium transition duration-200 flex items-center shadow-md btn-touch">
...
<div id="confirmPriceModal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center hidden z-50 backdrop-blur-sm">
    <div class="bg-gradient-to-br from-[#2c2c2c] to-[#1e1e1e] p-6 rounded-xl border border-green-600 border-opacity-40 w-full max-w-lg mx-4 transform transition-all duration-300 ease-in-out scale-95 shadow-2xl">
        ...
        <div class="text-gray-300 text-base mb-6">
            <p class="mb-3">Please review the updated prices below:</p>
            <ul id="priceList" class="space-y-2 text-gray-200"></ul>
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const confirmModal = document.getElementById('confirmPriceModal');
