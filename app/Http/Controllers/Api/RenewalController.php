...
class RenewalController extends Controller
{
    public function renewMembershipApp(Request $request)
    {
        ...
        $request->validate([
            ...
            'payment_screenshot' => 'nullable|string|required_if:payment_method,gcash|regex:/^uploads\/payments\/[a-zA-Z0-9_]+\.(jpg|jpeg|png)$/',
        ]);
        ...
        try {
            ...
            $paymentScreenshotPath = $request->payment_screenshot ? asset($request->payment_screenshot) : null;
            ...
            return response()->json([
                ...
                'user' => $user,
                'screenshot_url' => $paymentScreenshotPath,
            ]);
    ...
    public function uploadPayment(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('payment_screenshot')) {
                ...
                $fullUrl = asset($path); // Generate full URL
                ...
                return response()->json([
                    ...
                    'data' => [
                        ...
                        'screenshot_path' => $fullUrl, // Return full URL
                    ]
                ], 200);
            }
