...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($filter == 'today') {
            ...
            // No date filters for 'all' case
            // Queries remain unfiltered for all records
        }
    ...
    public function generateReport(Request $request)
    {
        ...
        if ($filter == 'today') {
            ...
            // No date filters applied for 'all' case
        }
    ...
    public function exportReport(Request $request)
    {
        $request->validate([
            ...
            'period' => 'required|in:today,thisWeek,thisMonth,thisYear,custom,all', // Updated: Added 'all'
